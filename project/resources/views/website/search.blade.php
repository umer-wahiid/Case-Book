...
<head>
    ...
    <link href="{{asset('website/assets/css/search.css')}}" rel="stylesheet">
        ...
        <div class="d-flex justify-content-center h-100">
            <div class="card">
                <div class="card-header">
                    <h3 style="padding-top:50px;font-weight:bold;">Search Your Case</h3>
                ...
                <div class="card-body">
                    <form method="post" action="{{url('/findsearch')}}">
                        ...
                        <div class="input-group form-group">
                            ...
                            <input type="text" name="CaseId" class="form-control" placeholder="Case No.">
